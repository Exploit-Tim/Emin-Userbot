...
async def bruh(message, user):
    ...
    name = "***" + name
    await message.edit(name + choice([" ", " ᴛɪᴅᴀᴋ "]) + "ᴀᴅᴀʟᴀʜ ꜱᴇᴏʀᴀɴɢ ᴘᴇɴɪᴘᴜ! ***")


cmdHelp.update(
    {
        "ᴀᴍᴏɴɢᴜꜱ": f"**ᴘʟᴜɢɪɴ : **`ᴀᴍᴏɴɢᴜꜱ`\
        \n\n  »  **ᴘᴇʀɪɴᴛᴀʜ :** `{cmd}imp`\
        \n  »  **ᴋᴇɢᴜɴᴀᴀɴ : **ᴋɪʀɪᴍᴋᴀɴ ɢᴀᴍʙᴀʀ ꜱᴇᴏʀᴀɴɢ ɪᴍᴘᴏꜱᴛᴏʀ ᴀᴍᴏɴɢ ᴜꜱ ᴅᴇɴɢᴀɴ ᴋᴀʟɪᴍᴀᴛ ᴅᴀʀɪ ᴀɴᴅᴀ.\
    "
    }
)
